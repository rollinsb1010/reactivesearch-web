	...
	function SelectedFilters(props) {
		...
		_this.renderFilters = function () {
			...
			return Object.keys(selectedValues).filter(function (id) {
				//add filter for group props
				return (_this.props.components.includes(id) && selectedValues[id].showFilter) || _this.props.components.map(component => _this.props.componentProps[component].group === id)
		...
		_this.hasFilters = function () {
			...
			return Object.keys(selectedValues).filter(function (id) {
				return components.includes(id) || components.map(component => componentProps[component].group === id)
